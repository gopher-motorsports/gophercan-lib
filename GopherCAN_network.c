...
U16_CAN_STRUCT rpm_ecu = {RPM_ECU_ID, 1, UNSIGNED16, UNSIGNED16_SIZE, LSB, 0.1, 0, 0, 0, 0};
FLOAT_CAN_STRUCT engine_temp_ecu = {ENGINE_TEMP_ECU_ID, 1, FLOATING, FLOATING_SIZE, MSB, 0.1, -180, 0, 0, 0};
U8_CAN_STRUCT tcm_neutral = {TCM_NEUTRAL_ID, 1, UNSIGNED8, UNSIGNED8_SIZE, LSB, 1, 0, 0, 0, 0};
