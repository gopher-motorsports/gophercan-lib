...
typedef enum
{
    ...
    CLUTCH_ID = 39,
    SLOW_CLUTCH_ID = 40,
    STEERING_ANGLE_ID = 41,
    THROTTLE_POSITION_ID = 42,
    ACCELERATION_ID = 43,
    RIDE_HEIGHT_REAR_ID = 44,
    RIDE_HEIGHT_FRONT_ID = 45,
    REAR_RIGHT_SHOCK_POT_ID = 46,
    REAR_LEFT_SHOCK_POT_ID = 47,
    FRONT_LEFT_SHOCK_POT_ID = 48,
    FRONT_RIGHT_SHOCK_POT_ID = 49,
    RIGHT_RAD_PRESSURE_IN_ID = 50,
    RIGHT_RAD_PRESSURE_OUT_ID = 51,
    RIGHT_RAD_PRESSURE_DROP_ID = 52,
    RIGHT_RAD_TEMP_IN_ID = 53,
    RIGHT_RAD_TEMP_OUT_ID = 54,
    LEFT_RAD_PRESSURE_IN_ID = 55,
    LEFT_RAD_PRESSURE_OUT_ID = 56,
    LEFT_RAD_PRESSURE_DROP_ID = 57,
    LEFT_RAD_TEMP_IN_ID = 58,
    LEFT_RAD_TEMP_OUT_ID = 59,
    AIR_TANK_PRESSURE_ID = 60,
    PNUMATIC_LINE_PRESSURE_ID = 61,
    WATER_PUMP_PRESSURE_IN_ID = 62,
    WATER_PUMP_PRESSURE_OUT_ID = 63,
    MAIN_CIRCUIT_FLOW_RATE_ID = 64,
    EXHAUST_TEMP_1_ID = 65,
    EXHAUST_TEMP_2_ID = 66,
    EXHAUST_TEMP_3_ID = 67,
    EXHAUST_TEMP_4_ID = 68,
    EXHAUST_TEMP_5_ID = 69,
    LAMBDA_HEADER_1_ID = 70,
    LAMBDA_HEADER_2_ID = 71,
    OIL_COOLER_TEMP_IN_ID = 72,
    OIL_COOLER_TEMP_OUT_ID = 73,
    OIL_COOLER_PRESSURE_IN_ID = 74,
    OIL_COOLER_PRESSURE_OUT_ID = 75,
    FIREWALL_TEMP_ID = 76,
    YAW_RATE_ID = 77,
    Y_AXIS_ACCEL_ID = 78,
    ROLL_RATE_ID = 79,
    ...
    BRAKE_TEMP_RL_ID = 84,
    BRAKE_TEMP_RR_ID = 85,
    TIRE_TEMP_RR_1_ID = 86,
    TIRE_TEMP_RR_2_ID = 87,
    TIRE_TEMP_RR_3_ID = 88,
    TIRE_TEMP_RR_4_ID = 89,
    TIRE_TEMP_RR_5_ID = 90,
    TIRE_TEMP_RR_6_ID = 91,
    TIRE_TEMP_RR_7_ID = 92,
    TIRE_TEMP_RR_8_ID = 93,
    TIRE_TEMP_RR_9_ID = 94,
    TIRE_TEMP_RR_10_ID = 95,
    TIRE_TEMP_RR_11_ID = 96,
    TIRE_TEMP_RR_12_ID = 97,
    TIRE_TEMP_RR_13_ID = 98,
    TIRE_TEMP_RR_14_ID = 99,
    TIRE_TEMP_RR_15_ID = 100,
    TIRE_TEMP_RR_16_ID = 101,
    TIRE_TEMP_RL_1_ID = 102,
    TIRE_TEMP_RL_2_ID = 103,
    TIRE_TEMP_RL_3_ID = 104,
    TIRE_TEMP_RL_4_ID = 105,
    TIRE_TEMP_RL_5_ID = 106,
    TIRE_TEMP_RL_6_ID = 107,
    TIRE_TEMP_RL_7_ID = 108,
    TIRE_TEMP_RL_8_ID = 109,
    TIRE_TEMP_RL_9_ID = 110,
    TIRE_TEMP_RL_10_ID = 111,
    TIRE_TEMP_RL_11_ID = 112,
    TIRE_TEMP_RL_12_ID = 113,
    TIRE_TEMP_RL_13_ID = 114,
    TIRE_TEMP_RL_14_ID = 115,
    TIRE_TEMP_RL_15_ID = 116,
    TIRE_TEMP_RL_16_ID = 117,
    TIRE_TEMP_FL_1_ID = 118,
    TIRE_TEMP_FL_2_ID = 119,
    TIRE_TEMP_FL_3_ID = 120,
    TIRE_TEMP_FL_4_ID = 121,
    TIRE_TEMP_FL_5_ID = 122,
    TIRE_TEMP_FL_6_ID = 123,
    TIRE_TEMP_FL_7_ID = 124,
    TIRE_TEMP_FL_8_ID = 125,
    TIRE_TEMP_FL_9_ID = 126,
    TIRE_TEMP_FL_10_ID = 127,
    TIRE_TEMP_FL_11_ID = 128,
    TIRE_TEMP_FL_12_ID = 129,
    TIRE_TEMP_FL_13_ID = 130,
    TIRE_TEMP_FL_14_ID = 131,
    TIRE_TEMP_FL_15_ID = 132,
    TIRE_TEMP_FL_16_ID = 133,
    TIRE_TEMP_FR_1_ID = 134,
    TIRE_TEMP_FR_2_ID = 135,
    TIRE_TEMP_FR_3_ID = 136,
    TIRE_TEMP_FR_4_ID = 137,
    TIRE_TEMP_FR_5_ID = 138,
    TIRE_TEMP_FR_6_ID = 139,
    TIRE_TEMP_FR_7_ID = 140,
    TIRE_TEMP_FR_8_ID = 141,
    TIRE_TEMP_FR_9_ID = 142,
    TIRE_TEMP_FR_10_ID = 143,
    TIRE_TEMP_FR_11_ID = 144,
    TIRE_TEMP_FR_12_ID = 145,
    TIRE_TEMP_FR_13_ID = 146,
    TIRE_TEMP_FR_14_ID = 147,
    TIRE_TEMP_FR_15_ID = 148,
    TIRE_TEMP_FR_16_ID = 149,
    SW_UPSHIFT_ID = 150,
    SW_DOWNSHIFT_ID = 151,
    SW_CLUTCH_FAST_ID = 152,
    SW_CLUTCH_SLOW_ID = 153,
    SW_AERO_FRONT_ID = 154,
    SW_AERO_REAR_ID = 155,
    TCM_NEUTRAL_ID = 156,
    TCM_GEAR_POSITION_ID = 157,
    TCM_SHIFTER_POSITION_ID = 158,
    TCM_CLUTCH_POSITION_ID = 159,
    TCM_TARGET_RPM_ID = 160,
    TCM_TRANS_RPM_ID = 161,
    TCM_CURRENT_GEAR_ID = 162,
    TCM_TARGET_GEAR_ID = 163,
    TCM_CURRENTLY_MOVING_ID = 164,
    TCM_SHIFT_STATE_ID = 165,
    TCM_USING_CLUTCH_ID = 166,
    TCM_SUCCESSFUL_SHIFT_ID = 167,
    TCM_ANTI_STALL_ID = 168,
    ACM_FL_WING_ANGLE_ID = 169,
    ACM_FR_WING_ANGLE_ID = 170,
    ACM_REAR_WING_ANGLE_ID = 171,
    PDM_0_CURRENT_ID = 172,
    PDM_1_CURRENT_ID = 173,
    PDM_2_CURRENT_ID = 174,
    PDM_3_CURRENT_ID = 175,
    PDM_4_CURRENT_ID = 176,
    PDM_5_CURRENT_ID = 177,
    PDM_6_CURRENT_ID = 178,
    PDM_7_CURRENT_ID = 179,
    PDM_8_CURRENT_ID = 180,
    PDM_9_CURRENT_ID = 181,
    PDM_10_CURRENT_ID = 182,
    PDM_11_CURRENT_ID = 183,
    PDM_12_CURRENT_ID = 184,
    PDM_13_CURRENT_ID = 185,
    PDM_14_CURRENT_ID = 186,
    PDM_15_CURRENT_ID = 187,
    PDM_16_CURRENT_ID = 188,
    PDM_17_CURRENT_ID = 189,
    PDM_18_CURRENT_ID = 190,
    PDM_19_CURRENT_ID = 191,
    PDM_VOLTAGE_ID = 192,
    PDM_TEMP_ID = 193,
    TCM_LAP_TIMER_ID = 194,
