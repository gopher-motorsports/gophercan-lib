...
typedef enum
{
    ...
    X_AXIS_ACCEL_ID = 76,
    Z_AXIS_ACCEL_ID = 77,
    TIRE_TEMP_RR_1_ID = 78,
    TIRE_TEMP_RR_2_ID = 79,
    TIRE_TEMP_RR_3_ID = 80,
    TIRE_TEMP_RR_4_ID = 81,
    TIRE_TEMP_RR_5_ID = 82,
    TIRE_TEMP_RR_6_ID = 83,
    TIRE_TEMP_RR_7_ID = 84,
    TIRE_TEMP_RR_8_ID = 85,
    TIRE_TEMP_RR_9_ID = 86,
    TIRE_TEMP_RR_10_ID = 87,
    TIRE_TEMP_RR_11_ID = 88,
    TIRE_TEMP_RR_12_ID = 89,
    TIRE_TEMP_RR_13_ID = 90,
    TIRE_TEMP_RR_14_ID = 91,
    TIRE_TEMP_RR_15_ID = 92,
    TIRE_TEMP_RR_16_ID = 93,
    TIRE_TEMP_RL_1_ID = 94,
    TIRE_TEMP_RL_2_ID = 95,
    TIRE_TEMP_RL_3_ID = 96,
    TIRE_TEMP_RL_4_ID = 97,
    TIRE_TEMP_RL_5_ID = 98,
    TIRE_TEMP_RL_6_ID = 99,
    TIRE_TEMP_RL_7_ID = 100,
    TIRE_TEMP_RL_8_ID = 101,
    TIRE_TEMP_RL_9_ID = 102,
    TIRE_TEMP_RL_10_ID = 103,
    TIRE_TEMP_RL_11_ID = 104,
    TIRE_TEMP_RL_12_ID = 105,
    TIRE_TEMP_RL_13_ID = 106,
    TIRE_TEMP_RL_14_ID = 107,
    TIRE_TEMP_RL_15_ID = 108,
    TIRE_TEMP_RL_16_ID = 109,
    TIRE_TEMP_FL_1_ID = 110,
    TIRE_TEMP_FL_2_ID = 111,
    TIRE_TEMP_FL_3_ID = 112,
    TIRE_TEMP_FL_4_ID = 113,
    TIRE_TEMP_FL_5_ID = 114,
    TIRE_TEMP_FL_6_ID = 115,
    TIRE_TEMP_FL_7_ID = 116,
    TIRE_TEMP_FL_8_ID = 117,
    TIRE_TEMP_FL_9_ID = 118,
    TIRE_TEMP_FL_10_ID = 119,
    TIRE_TEMP_FL_11_ID = 120,
    TIRE_TEMP_FL_12_ID = 121,
    TIRE_TEMP_FL_13_ID = 122,
    TIRE_TEMP_FL_14_ID = 123,
    TIRE_TEMP_FL_15_ID = 124,
    TIRE_TEMP_FL_16_ID = 125,
    TIRE_TEMP_FR_1_ID = 126,
    TIRE_TEMP_FR_2_ID = 127,
    TIRE_TEMP_FR_3_ID = 128,
    TIRE_TEMP_FR_4_ID = 129,
    TIRE_TEMP_FR_5_ID = 130,
    TIRE_TEMP_FR_6_ID = 131,
    TIRE_TEMP_FR_7_ID = 132,
    TIRE_TEMP_FR_8_ID = 133,
    TIRE_TEMP_FR_9_ID = 134,
    TIRE_TEMP_FR_10_ID = 135,
    TIRE_TEMP_FR_11_ID = 136,
    TIRE_TEMP_FR_12_ID = 137,
    TIRE_TEMP_FR_13_ID = 138,
    TIRE_TEMP_FR_14_ID = 139,
    TIRE_TEMP_FR_15_ID = 140,
    TIRE_TEMP_FR_16_ID = 141,
    SW_UPSHIFT_ID = 142,
    SW_DOWNSHIFT_ID = 143,
    SW_CLUTCH_ID = 144,
    SW_DRS_ID = 145,
    ...
    SW_AUX3_ID = 147,
    TCM_NEUTRAL_ID = 148,
    TCM_SHIFTER_POSITION_ID = 149,
    TCM_CLUTCH_POSITION_ID = 150,
    TCM_TARGET_RPM_ID = 151,
    TCM_TRANS_RPM_ID = 152,
    TCM_CURRENT_GEAR_ID = 153,
    TCM_TARGET_GEAR_ID = 154,
    TCM_CURRENTLY_MOVING_ID = 155,
    TCM_THROTTLE_BLIP_ID = 156,
    TCM_USING_CLUTCH_ID = 157,
    TCM_SUCCESSFUL_SHIFT_ID = 158,
    TCM_ANTI_STALL_ID = 159,
    ACM_FL_WING_ANGLE_ID = 160,
    ACM_FR_WING_ANGLE_ID = 161,
    ACM_REAR_WING_ANGLE_ID = 162,
    PDM_1_CURRENT_ID = 163,
    PDM_2_CURRENT_ID = 164,
    PDM_3_CURRENT_ID = 165,
    PDM_4_CURRENT_ID = 166,
    PDM_5_CURRENT_ID = 167,
    PDM_6_CURRENT_ID = 168,
    PDM_7_CURRENT_ID = 169,
    PDM_8_CURRENT_ID = 170,
    PDM_9_CURRENT_ID = 171,
    PDM_10_CURRENT_ID = 172,
    PDM_11_CURRENT_ID = 173,
    PDM_12_CURRENT_ID = 174,
    PDM_13_CURRENT_ID = 175,
    PDM_14_CURRENT_ID = 176,
    PDM_15_CURRENT_ID = 177,
    PDM_16_CURRENT_ID = 178,
    PDM_17_CURRENT_ID = 179,
    PDM_18_CURRENT_ID = 180,
    PDM_19_CURRENT_ID = 181,
    PDM_20_CURRENT_ID = 182,
    PDM_VOLTAGE_ID = 183,
    PDM_TEMP_ID = 184,
...
extern U8_CAN_STRUCT sw_clutch;
extern U8_CAN_STRUCT sw_drs;
extern U8_CAN_STRUCT sw_aux2;
extern U8_CAN_STRUCT sw_aux3;
