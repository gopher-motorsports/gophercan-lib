...
typedef enum
{
    ...
    SW_AERO_REAR_ID = 151,
    TCM_NEUTRAL_ID = 152,
    TCM_GEAR_POSITION_ID = 153,
    TCM_SHIFTER_POSITION_ID = 154,
    TCM_CLUTCH_POSITION_ID = 155,
    TCM_TARGET_RPM_ID = 156,
    TCM_TRANS_RPM_ID = 157,
    TCM_CURRENT_GEAR_ID = 158,
    TCM_TARGET_GEAR_ID = 159,
    TCM_CURRENTLY_MOVING_ID = 160,
    TCM_SHIFT_STATE_ID = 161,
    TCM_USING_CLUTCH_ID = 162,
    TCM_SUCCESSFUL_SHIFT_ID = 163,
    TCM_ANTI_STALL_ID = 164,
    ACM_FL_WING_ANGLE_ID = 165,
    ACM_FR_WING_ANGLE_ID = 166,
    ACM_REAR_WING_ANGLE_ID = 167,
    PDM_0_CURRENT_ID = 168,
    PDM_1_CURRENT_ID = 169,
    PDM_2_CURRENT_ID = 170,
    PDM_3_CURRENT_ID = 171,
    PDM_4_CURRENT_ID = 172,
    PDM_5_CURRENT_ID = 173,
    PDM_6_CURRENT_ID = 174,
    PDM_7_CURRENT_ID = 175,
    PDM_8_CURRENT_ID = 176,
    PDM_9_CURRENT_ID = 177,
    PDM_10_CURRENT_ID = 178,
    PDM_11_CURRENT_ID = 179,
    PDM_12_CURRENT_ID = 180,
    PDM_13_CURRENT_ID = 181,
    PDM_14_CURRENT_ID = 182,
    PDM_15_CURRENT_ID = 183,
    PDM_16_CURRENT_ID = 184,
    PDM_17_CURRENT_ID = 185,
    PDM_18_CURRENT_ID = 186,
    PDM_19_CURRENT_ID = 187,
    PDM_VOLTAGE_ID = 188,
    PDM_TEMP_ID = 189,
    TCM_LAP_TIMER_ID = 190,
